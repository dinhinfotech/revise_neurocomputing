...
\label{fig:subfig4}}
\caption{The performance of the system w.r.t the change of each hyper-parameter: (a) clique threshold, (b) distance threshold, (c) degree threshold, (d) real vec size threshold}
\label{fig:globfig}
\end{figure}
